...
class FollowingAdapter(var context: Context, private var githubResultList: MutableList<GitUser>?, private val listener: OnItemClickListener): RecyclerView.Adapter<FollowingViewHolder>() {
    ...
    override fun onCreateViewHolder(parentView: ViewGroup, position: Int): FollowingViewHolder {
